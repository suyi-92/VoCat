...
// Linux device nodes may be unlinked and recreated while a descriptor for the
// previous inode remains open. Windows intentionally does not share that file
// replacement model, and VoCat's native QMI port support is Linux-only.
